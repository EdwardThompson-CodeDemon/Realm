package sparta.realm.annotationprocessor;
...
import sparta.realm.DynamicClass;
import sparta.realm.DynamicProperty;
import sparta.realm.SyncDescription;
import sparta.realm.db_class_;
import sparta.realm.sync_service_description;
import sparta.realm.sync_status;


@AutoService(RProcessor.class)
@SupportedAnnotationTypes({"sparta.realm.aannotations.DynamicClass","sparta.spartaannotations.DbSync"})
