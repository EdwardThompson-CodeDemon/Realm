...
public class asbgw  {
     ...
     * @deprecated
     * This method is no longer used,its slow compaired to {@link this#setup_sync_action_ann()} also uses previous heavy dynamicproperty classes and runtime reflection .
...
//            +"download link :"+ssd_t.download_link+"\n");
     ...
     * @deprecated
     * This method is no longer used,its slow compaired to {@link this#setup_sync_action_ann()} which is almost twice as fast with annotation.
            ...
            protected Object doInBackground(Object[] params) {
                ...
                try {
                    ...
                    if (maindata.getBoolean("IsOkay")) {
                        ...
                        sd.register_object(true,null,null,null);
                        for (int i = 0; i < temp_ar.length(); i++) {
                            ...
                            sd.register_object(null,jj,obj_class,ssd.service_name);
                        ...
                        sd.register_object(false,null,null,null);
            ...
            protected Object doInBackground(Object[] params) {
                ...
                try {
                    ...
                    if (maindata.getBoolean("IsOkay")) {
                        ...
                        {
                            if(od.name().equalsIgnoreCase(dyna_data_obj.operatio_data_type.Null.name())){continue;}
            ...
            protected Object doInBackground(Object[] params) {
                ...
                try {
                    ...
                    try {
                        ...
                        Cursor c = new sdbw(act).database.rawQuery("SELECT CURRENT_TIMESTAMP", null);
                        if (c.moveToFirst()) {
                            do {
