...
import sparta.realm.spartaviews.FaceImageView;
...
public class face_handler {
   ...
   public static void begin_face_extraction(Context act)
    {
        View aldv= LayoutInflater.from(SpartaApplication.getAppContext()).inflate(R.layout.dialog_face_extraction,null);
        final AlertDialog ald =new AlertDialog.Builder(SpartaApplication.getAppContext())
                .setView(aldv)
                                .create();
...
ald.show();
        ...
        aldv.findViewById(R.id.exit).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Thread(()->{
                    ...
                    for (Object o:sd.load_dynamic_records(new member_data(),new String[]{"data_type='"+svars.data_type_indexes.photo+"'","data_index='"+ svars.image_indexes.profile_photo+"'",unconverted_only}))
                    {
                        ...
                        aldv.post(new Runnable() {
                            @Override
                            public void run() {
                                int total_imgs=Integer.parseInt(sd.get_record_count(mb.table_name,new String[]{"data_type='"+svars.data_type_indexes.photo+"'","data_index='"+svars.image_indexes.profile_photo+"'"}));

                                ((ProgressBar)aldv.findViewById(R.id.progress)).setMax(total_imgs);
                                int total_faces=Integer.parseInt(sd.get_record_count(mb.table_name,new String[]{"data_type='"+svars.data_type_indexes.photo+"'","data_index='"+svars.image_indexes.croped_face+"'"}));
    ...
    {
        String picture_path=svars.WORKING_APP.file_path_employee_data +mb.data.value;
        ...
        if (result == FSDK.FSDKE_OK) {
            ...
            if (result == FSDK.FSDKE_OK) {
                ...
                if (result == FSDK.FSDKE_OK) {
                    ...
                    picture_path = svars.WORKING_APP.file_path_employee_data +img_name;
                    ...
                    sd.register_object(null,sd.load_JSON_from_object(mb),mb,"");
