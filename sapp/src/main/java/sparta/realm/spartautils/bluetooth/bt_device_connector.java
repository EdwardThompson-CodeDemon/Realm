...
import sparta.realm.spartautils.bluetooth.adapters.bt_devicelist_adapter;
...
//paired_devices=(ArrayList<BluetoothDevice>) pairedDevices;
    ...
    public void show(final device_selection_handler dhm)
    {
        ...
        if (mBtAdapter.isEnabled()) {
            ...
            {
                title.setText("Bt Settings|Printer Selection");
            }else if(device_type== bt_device_type.fp_device)
            {
                title.setText("Bt Settings|FP device Selection");

            }else if(device_type== bt_device_type.weighbridge_model)
            {
                title.setText("Bt Settings|Weighbridge Selection");

            }else if(device_type== bt_device_type.lb_access_point)
            {
                title.setText("Bt Settings|Access point Selection");
