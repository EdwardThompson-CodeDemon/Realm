...
/**
 * Created by Edward Thompson on 08-Feb-17.
 */

public class BTV3 extends FingerprintManger{
    ...
    sfp_i interf;
       public BTV3(final Activity activity) {
           super(activity);
...
//                        AddStatusList("Time Out");
            ...
            mTimerTimeout.schedule(mTaskTimeout, 5000, 5000);
        }
