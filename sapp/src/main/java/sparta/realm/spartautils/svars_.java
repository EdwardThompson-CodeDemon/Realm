...
//    public static AppConfig current_app_config(Realm.context) = BUKINA();
    ...
    public static int fingerprints_request_limit = 5000;
    public static int images_request_limit = 1;
 public static int fees_request_limit = 5000;
   ...
   // public static String Member_download_link =Mainlink+"/Students/Details/GetMobileRecords";
...
public static class remember_indexes {
    ...
    public static class data_type_indexes {
        public static int
                fingerprints = 1,
                photo = 2,
 ...
 public static void set_module_active(Context act,String module_name, boolean module_active) {
   ...
   public static boolean module_use_face(Context act,String module_name) {
    ...
    public static boolean version_action_done(Context act, version_action va) {
        ...
        boolean ok= prefs.getString("v_a_" + va.name(), "").equalsIgnoreCase(svars.current_version());
    ...
    public static void set_version_action_done(Context act, version_action va) {
        ...
        saver.putString("v_a_" + va.name(), svars.current_version());
        saver.commit();
...
public static void set_enrlock(Context act, String enrloc_rc) {
 ...
 public static int receipt_period(Context act) {
    ...
    public static void set_bt_device_address(Context act, bt_device_connector.bt_device_type dev_type, String macaddress) {
