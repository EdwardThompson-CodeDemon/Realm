...
//            }
            ...
            md.callback.onActionLogged("Sent mail successfully "+(md.retrycount>0?"after "+md.retrycount+" retries":""));
            md.callback.onMailSent();

            Log.i(logTag,"Sent mail successfully "+(md.retrycount>0?"after "+md.retrycount+" retries":"..."));
