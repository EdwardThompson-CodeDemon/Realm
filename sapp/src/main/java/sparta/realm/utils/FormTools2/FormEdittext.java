...
import sparta.realm.utils.FormTools.ContainsInputFilter;
...
//        title.setBackgroundColor(Color.RED);
        ...
        inputText.setHint(R.string.dd_mm_yyyy);
...
if(!mandatory){
    ...
    public void setInputField(@NonNull InputField inputField, InputListener inputListener) {
        reset();
...
//                new DateInputMask(inputText, validationRules.date_time_input_format);
    ...
    public boolean setError(String error) {
        ...
        inputText.getBackground().mutate().setColorFilter(getResources().getColor(error==null?android.R.color.darker_gray:android.R.color.holo_red_light), PorterDuff.Mode.SRC_ATOP);
//        inputText.getBackground().mutate().setColorFilter(getResources().getColor(android.R.color.darker_gray), PorterDuff.Mode.SRC_ATOP);
