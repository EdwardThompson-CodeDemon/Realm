...
//        result.remove(result.size() - 1);
    ...
    public void clearItems(boolean updateui) {
...
//                        activity.takePhoto("2");
        ...
        void populate(int position) {
            ...
            if (memberImage.transaction_no != null && memberImage.transaction_no.equals(addImageTransactionNo)) {
                image.setImageDrawable(context.getDrawable(new Random().nextInt() % 2 == 0 ? R.drawable.baseline_add_24 : R.drawable.baseline_add_photo_alternate_24));
