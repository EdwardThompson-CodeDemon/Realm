...
SpartaAppCompactFingerPrintActivity activity;
 ...
 @Override
  ...
  default void onImageCleared() {
    ...
    void setupUI() {
        title = new TextView(getContext(), null, R.style.AppTheme_SubTitle);
...
//        title.setTypeface(null, Typeface.BOLD);
        ...
        mandatoryIndicator =  new TextView(getContext(), null, sparta.realm.R.style.TextAppearance_AppCompat_SearchResult_Title);
        mandatoryIndicator.setText(" * ");
        mandatoryIndicator.setTextColor(getContext().getColor(sparta.realm.R.color.gold));
...
//            if(!activity.isPackageInstalled("sparta.realm.iccaoluxand")) {
...
mandatoryIndicator.setVisibility(mandatory?VISIBLE:GONE);
    }
