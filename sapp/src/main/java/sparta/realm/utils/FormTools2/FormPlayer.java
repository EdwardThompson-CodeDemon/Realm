...
import sparta.realm.utils.FormTools.models.MemberFingerprints;
...
public class FormPlayer extends ConstraintLayout {
  ...
  default boolean onPageChanging(InputGroup inputField, int from,int to) {
return true;
        }

        default void onInputFieldDataSet(InputField inputField, int index) {

        }

        default boolean onPageValidation(InputGroup inputGroup, boolean valid) {
            return valid;
        }
...
//        title = new TextView(getContext(), null, R.style.Theme_WeighbridgeDemo_Title);
        ...
        instructions = new TextView(getContext(), null);
        instructions.setText("Fill in the details below to fill the form");
        instructions.setTextColor(getContext().getColor(R.color.gray));
...
//        previous.setText("< Previous");
        previous.setText(getContext().getString(R.string.previous));
...
//                return shouldDisplay(inputField.inputFieldInputConstraint);
            ...
            public InputFieldInputConstraintProcessingResult onInputFieldInputConstraintProcessingResultRequired(InputField inputField) {
                return getInputFieldInputConstraintProcessingResultV3(inputField.inputFieldInputConstraints, form.inputGroups);
            }
        });
...
//                return independentInput.equals(inputFieldInputConstraint.operation_value);
    ...
    InputFieldInputConstraintProcessingResult getInputFieldInputConstraintProcessingResultV2(ArrayList<InputFieldInputConstraint> inputFieldInputConstraints_, ArrayList<InputGroup> inputGroups) {
        ...
        Boolean equalToIncludeOnlyElseShowAllCanDisplay = true;
        Boolean notEqualToIncludeOnlyElseShowAllCanDisplay = true;
...
//                        inputFieldInputConstraintProcessingResult.tableFilters.add("sid IN (" + inputFieldInputConstraint.dataset_values + ")");
        ...
        if (includeOnlyFilterCanDisplay != null) {
            inputFieldInputConstraintProcessingResult.field_active = includeOnlyFilterCanDisplay;
            return inputFieldInputConstraintProcessingResult;
        }
        remainingInputFieldInputConstraints.clear();
        for (InputFieldInputConstraint inputFieldInputConstraint : inputFieldInputConstraints) {
...
//                        String independentValue = getField(registeringObject, getInputField(independentInputFieldVariable.independent_input_field).object_field_name);
        ...
        inputFieldInputConstraints.clear();
        equal_to_include_only_else_all_loop:
        for (InputFieldInputConstraint inputFieldInputConstraint : remainingInputFieldInputConstraints) {
            switch (InputFieldInputConstraint.ConstraintType.values()[Integer.parseInt(inputFieldInputConstraint.constraint_type)]) {
                case EQUAL_TO_INCLUDE_ONLY_ELSE_SHOW_ALL:
                    Boolean orFilterOk = null;
                    for (IndependentInputFieldVariable independentInputFieldVariable : inputFieldInputConstraint.orIndependentInputFieldVariables) {
//                        String independentValue = getField(registeringObject, getInputField(independentInputFieldVariable.independent_input_field,inputGroups).object_field_name);
                        String independentValue = getInputField_(independentInputFieldVariable.independent_input_field, inputGroups).input;
...
//                        String independentValue = getField(registeringObject, getInputField(independentInputFieldVariable.independent_input_field).object_field_name);
                    ...
                    if (andFilterOk != null && andFilterOk) {
                        ...
                        inputFieldInputConstraintProcessingResult.field_active = true;
                        return inputFieldInputConstraintProcessingResult;
                    } else if (orFilterOk == null || orFilterOk == false) {
                        inputFieldInputConstraintProcessingResult.field_active = true;
                        return inputFieldInputConstraintProcessingResult;
                    }
        ...
        inputFieldInputConstraints.clear();
        not_equal_to_include_only_else_all_loop:
        for (InputFieldInputConstraint inputFieldInputConstraint : remainingInputFieldInputConstraints) {
            switch (InputFieldInputConstraint.ConstraintType.values()[Integer.parseInt(inputFieldInputConstraint.constraint_type)]) {
                case NOT_EQUAL_TO_INCLUDE_ONLY_ELSE_SHOW_ALL:
                    Boolean orFilterOk = null;
                    for (IndependentInputFieldVariable independentInputFieldVariable : inputFieldInputConstraint.orIndependentInputFieldVariables) {
//                        String independentValue = getField(registeringObject, getInputField(independentInputFieldVariable.independent_input_field,inputGroups).object_field_name);
//                        String independentValue = getInputField_(independentInputFieldVariable.independent_input_field,inputGroups).input;
...
//                            inputFieldInputConstraintProcessingResult.field_active = false;
    ...
    InputFieldInputConstraintProcessingResult getInputFieldInputConstraintProcessingResultV3(ArrayList<InputFieldInputConstraint> inputFieldInputConstraints_, ArrayList<InputGroup> inputGroups) {
        ArrayList<InputFieldInputConstraint> inputFieldInputConstraints = new ArrayList<>(inputFieldInputConstraints_);
        ArrayList<InputFieldInputConstraint> remainingInputFieldInputConstraints = new ArrayList<>();
        InputFieldInputConstraintProcessingResult inputFieldInputConstraintProcessingResult = new InputFieldInputConstraintProcessingResult();
            if (FormPlayerValidator.constraintExists(inputFieldInputConstraints_, InputFieldInputConstraint.ConstraintType.EqualTo)) {
            InputFieldInputConstraintProcessingResult equalToInputFieldInputConstraintProcessingResult = FormPlayerValidator.processEqualToConstraint(inputFieldInputConstraints_, inputGroups, inputFieldInputConstraintProcessingResult);
            if (!equalToInputFieldInputConstraintProcessingResult.field_active) {
                if (FormPlayerValidator.constraintExists(inputFieldInputConstraints_, InputFieldInputConstraint.ConstraintType.NotEqualTo)) {
                    FormPlayerValidator.processNotEqualToConstraint(inputFieldInputConstraints_, inputGroups, inputFieldInputConstraintProcessingResult);
                    if (!inputFieldInputConstraintProcessingResult.field_active) {
            ...
            //check table filter constraints
        }

        if (FormPlayerValidator.constraintExists(inputFieldInputConstraints_, InputFieldInputConstraint.ConstraintType.ParentChild)) {

            FormPlayerValidator.processParentChildConstraint(inputFieldInputConstraints_, inputGroups, inputFieldInputConstraintProcessingResult);
            if (!inputFieldInputConstraintProcessingResult.field_active) {
                return inputFieldInputConstraintProcessingResult;
        ...
        if (FormPlayerValidator.constraintExists(inputFieldInputConstraints_, InputFieldInputConstraint.ConstraintType.IncludeOnly)) {

            FormPlayerValidator.processIncludeOnlyConstraint(inputFieldInputConstraints_, inputGroups, inputFieldInputConstraintProcessingResult);
            if (!inputFieldInputConstraintProcessingResult.field_active) {
                return inputFieldInputConstraintProcessingResult;
        ...
        if (FormPlayerValidator.constraintExists(inputFieldInputConstraints_, InputFieldInputConstraint.ConstraintType.Exclude)) {

            FormPlayerValidator.processExcludeConstraint(inputFieldInputConstraints_, inputGroups, inputFieldInputConstraintProcessingResult);

        }

        if (FormPlayerValidator.constraintExists(inputFieldInputConstraints_, InputFieldInputConstraint.ConstraintType.EQUAL_TO_INCLUDE_ONLY_ELSE_SHOW_ALL)) {

            FormPlayerValidator.processEqualToIncludeOnlyElseShowAllConstraint(inputFieldInputConstraints_, inputGroups, inputFieldInputConstraintProcessingResult);

        }


        for (InputFieldInputConstraint inputFieldInputConstraint : inputFieldInputConstraints_) {
            switch (InputFieldInputConstraint.ConstraintType.values()[Integer.parseInt(inputFieldInputConstraint.constraint_type)]) {
                case NOT_EQUAL_TO_INCLUDE_ONLY_ELSE_SHOW_ALL:
                    Boolean orFilterOk = null;
                    for (IndependentInputFieldVariable independentInputFieldVariable : inputFieldInputConstraint.orIndependentInputFieldVariables) {
...
//        }
    ...
    public void nextPage() {
        if(!inputListener.onPageChanging(currentPage,currentPageIndex,currentPageIndex + 1))return;
        if (lastPage) {
//            showSaveDialog();
        } else {
...
//                    throw new RuntimeException(e);
    ...
    public boolean validated() {
        ...
        InputField inputField=currentPage.inputFields.stream()
                .filter(p -> !p.inputValid)
                .findAny()
                .orElse(null);
        if(inputField!=null){
            recyclerView.scrollToPosition(formAdapter.page.inputFields.indexOf(inputField));
        }
        return inputListener.onPageValidation(currentPage, inputField == null);
    }
